...
-(void)viewDidLoad{
    ...
    [zooz preInitialize:@"951bde04-5a26-4200-a94e-34d775a1e5f9" isSandboxEnv:IS_SANDBOX withCurrencyCode:@"EUR"];
...
//    zooz.barTitleImage = [UIImage imageNamed:@"MyLogo.png"];
    ...
    */
 //   ZooZPaymentRequest * req = [zooz createSubscriptionRequestWithTotal:1 andCurrencyCode:@"USD" every:1 periodUnit:SubscriptionUnitMonth forNumberOfPeriods:12 invoiceRefNumber:@"11" delegate:self];
...
/* 
 //for apps that force landscape mode - need to enable portrait in the target settings, and override in all controllers the following methods but allow Landscape only
 //for the controller that invokes ZooZ these methods shoule be overriden like the following
